$.widget( "ui.autoselect", {
	...
	_create: function(){
		...
		var wrapper = $( "<span>" ).addClass( "ui-autoselect" ).insertAfter( select );

		var input = $( "<input>" )
					.appendTo( wrapper )
					.val(data[select.selectedIndex])
					.addClass( "ui-state-default ui-autoselect-input" )
		...
		$("<a>")
			...
			.addClass( "ui-corner-right ui-autoselect-toggle" )
			.click(function() {
